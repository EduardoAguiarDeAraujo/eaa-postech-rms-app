...
public class RestaurantResponse {
    ...
    public RestaurantResponse(UUID id, String name, CuisineType cuisineType, LocalTime openTime, LocalTime closeTime, User owner, Address address, List<Menu> menus) {
        this.id = id;
        this.name = name;
